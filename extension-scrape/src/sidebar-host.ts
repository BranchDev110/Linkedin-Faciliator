const HOST_ID = 'li-job-scraper-host';
const PAGE_STYLE_ID = 'li-job-scraper-page-styles';
const HOST_FLAG = '__liJobScraperSidebarHostLoaded';
const SIDEBAR_WIDTH = '30vw';
const SIDEBAR_OPEN_CLASS = 'li-job-scraper-sidebar-open';
